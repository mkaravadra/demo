package com.westpac.test.client;	
...
import com.westpac.test.client.beans.Comment;
import com.westpac.test.client.beans.Post;
import com.westpac.test.client.beans.User;
